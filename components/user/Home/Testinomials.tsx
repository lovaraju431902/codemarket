  ...
  return (
    ...
    <section className="relative  bg-linear-to-r overflow-hidden from-slate-100 to-purple-200 py-10">
      ...
      >
        ...
        <h3 className="text-muted-foreground  mb-8 max-w-lg text-center text-lg font-medium tracking-tight text-balance">
          Don&apos;t just take our word for it. Here&apos;s what{' '}
          <span className="bg-gradient-to-r from-blue-500 to-sky-500 bg-clip-text text-transparent">
            real freelancers and developers
          </span>{' '}
          are saying about{' '}
          <span className="font-semibold text-blue-500">CodeBetter</span>
        </h3>
      </motion.div>
